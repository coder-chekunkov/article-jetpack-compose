...
internal class EmployeeRepository {
    ...
    /** Создание тестовых сорудников компании */
    private fun createNewEmployees(): List<Employee> {
        return (1..50).map {
            Employee(
                id = it.toLong(),
    ...
    /** Создание рандомной должности */
    private fun createPosition(): Position {
        return when (faker.random().nextInt(0, 3)) {
            0 -> Position.JUNIOR
            1 -> Position.MIDDLE
            2 -> Position.SENIOR
            else -> Position.ARCHITECT
        }
    }

    companion object {
        /** Доступные изображения для фото сотрудниов в тестовых данных */
